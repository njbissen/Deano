...
{
	public static class GetForumThreads
	{
		[FunctionName("GetForumThreads")]
		public static async Task<IActionResult> Run(
			[HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "Forums/{Id}/Threads")] HttpRequest req,
			ILogger log, string id)
		{
			...
			try
			{
				...
				var results = await storage.GetThreads(id, pageIndex, pageSize);
