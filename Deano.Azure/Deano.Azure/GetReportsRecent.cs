...
{
	public static class GetReportsRecent
	{
		[FunctionName("GetReportsRecent")]
		public static async Task<IActionResult> Run(
			[HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "Reports/Recent")] HttpRequest req,
			ILogger log)
		{
			...
			try
			{
				...
				var reports = await storage.GetReportsRecent(pageIndex, pageSize);
