...
namespace Deano.Data
{
    public partial class Repository
    {
        ...
        {
            //todo return user;
            //User user = context.Users.FirstOrDefault(m => m.Username.Equals(username));
            //return user;
            return null;
        }
        ...
        {
            User user = context.Users.FirstOrDefault(m => m.Username.Equals(username) && m.Password.Equals(password));
            return user;
        }
